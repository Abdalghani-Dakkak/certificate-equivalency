  ...
  <div class="row q-col-gutter-sm">
    ...
    <div class="col-12 col-md-3">
      <CustomQSelect
        ...
        label="المنطقة"
        :get-data="
          () => locationStore.getDistrict(locationStore.lstGovernorate.selected?.id as number)
        "
    ...
    <div class="col-12 col-md-3">
      <CustomQSelect
        ...
        label="الناحية"
        :get-data="
          () => locationStore.getSubdistrict(locationStore.lstDistrict.selected?.id as number)
        "
    ...
    <div class="col-12 col-md-3">
      <CustomQSelect
        ...
        label="البلدة"
        :get-data="
          () => locationStore.getCommunity(locationStore.lstSubdistrict.selected?.id as number)
        "
    ...
    <div class="col-12 col-md-3 hidden">
      <q-input v-model="placeCode" label="رمز الموقع" :readonly="true" dense outlined />
    </div>
  </div>
</template>
